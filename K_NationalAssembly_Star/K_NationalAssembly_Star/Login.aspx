<%@ Page Title="Login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="K_NationalAssembly_Star.Login" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
       <asp:Button ID="btnLogin" runat="server" Text="로그인" Width="150px" BackColor="#339966" Font-Bold="True" ForeColor="White" OnClick="btnLogin_Click" Height="30px" BorderColor="#339966" Font-Names="나눔바른고딕" Font-Size="Medium"/>
        <asp:Button ID="btnRegister" runat="server" BackColor="#339966" ForeColor="White" Height="30px" Text="회원가입" Width="150px" BorderColor="#339966" Font-Bold="True" Font-Names="나눔바른고딕" Font-Size="Medium" OnClick="btnRegister_Click" />
    </p>
</asp:Content>
