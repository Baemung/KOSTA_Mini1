<%@ Page Title="Discussion" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Discussion.aspx.cs" Inherits="PoliticInform.Discussion" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:miniProject2ConnectionString3 %>" SelectCommand="SELECT [BILL_NO], [BILL_NAME], [PROPOSER], [DETAIL_LINK], [COMMITTEE], [PROPOSE_DT], [PROC_RESULT] FROM [Proposition]"></asp:SqlDataSource>
</asp:Content>
